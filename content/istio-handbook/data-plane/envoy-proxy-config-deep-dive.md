...
![Envoy 配置](../../images/006tNbRwly1fy2x2zk1hhj30ee0h9jtg.jpg "Envoy 配置")

由于 bootstrap 中的配置是来自 Envoy 启动时加载的静态文件，主要配置了节点信息、tracing、admin 和统计信息收集等信息，这不是本文的重点，大家可以自行研究。

![bootstrap 配置](../../images/006tNbRwly1fy2xid761zj30c70ai0tj.jpg "bootstrap 配置")
