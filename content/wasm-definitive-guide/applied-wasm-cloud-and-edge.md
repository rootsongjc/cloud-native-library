...
summary: 这是《WebAssembly 权威指南》一书的第十五章，在云和边缘应用 WebAssembly。
weight: 16
icon: book-reader
icon_pack: fas
draft: false
...
老实说，我认为可以肯定地说，许多人并不了解云计算的全部范围。与采购物理硬件系统往往困难重重的情况相比，云计算的特点是速度提升明显，实例启动方便。但是把所有东西都放在云端和把所有东西都不放在云端一样愚蠢。
