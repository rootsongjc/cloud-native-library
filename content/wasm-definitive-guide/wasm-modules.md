...
在 [第二章](../hello-world/) 中，你已经看到了一个比我们在本章开始时更复杂的模块结构。我们将逐步介绍这些部分，然后向你展示一些工具，以探索 WebAssembly 模块的文本和视觉结构。在上一章中，我们已经简单地讨论了二进制结构。它结构紧凑，传输和加载速度快。你可能不会经常花很多时间去看二进制的细节，因为你的注意力会放在软件方面。熟悉模块的布局是很有用的，所以我们来看看。
