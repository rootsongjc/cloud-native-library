...
![增加 kubeclt 命令的工具（图片来自网络）](../../images/tools-to-supercharge-kubectl.jpg "增加kubeclt命令的工具（图片来自网络）")
...
![增强的 kubectl 命令](../../images/supercharged-kubectl.jpg "增强的kubectl命令")
...
![kube-shell 页面](../../images/kube-shell.jpg "kube-shell页面")
