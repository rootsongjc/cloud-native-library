...
![图 3：有 sidecar 代理作为日志容器的 Pod 组件](../images/f3.jpg "图3：有 sidecar 代理作为日志容器的 Pod 组件")
...
![图 4：容器的构建工作流程，用 webhook 和准入控制器进行优化](../images/f4.jpg "图4：容器的构建工作流程，用 webhook 和准入控制器进行优化")
