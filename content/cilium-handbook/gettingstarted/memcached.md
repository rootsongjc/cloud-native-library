...
-   **A-wing**: can set coordinates to key \"awing-coord\" and get the
    key coordinates.
...
With L4 port access to the memcached server, all starfighters could
...
Apply this Memcached-aware network security policy using `kubectl` in
