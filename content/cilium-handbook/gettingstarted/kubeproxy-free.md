...
As can be seen, Cilium\'s eBPF kube-proxy replacement is set up
correctly.
...
A Helm example configuration in a kube-proxy-free environment with
...
For introspection, iproute2 displays them only as \"extern_learn\" in
